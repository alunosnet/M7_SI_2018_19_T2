<%@ Page Title="" Language="C#" MasterPageFile="~/MasterPage.Master" AutoEventWireup="true" CodeBehind="pesquisar.aspx.cs" Inherits="M7_TrabalhoModelo_T2.Admin.Utilizadores.pesquisar" %>
<asp:Content ID="Content1" ContentPlaceHolderID="head" runat="server">
</asp:Content>
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
<h2>Pesquisar utilizadores</h2>
    Nome do utilizador: <asp:TextBox runat="server" ID="tbnome"></asp:TextBox><asp:Button runat="server" ID="bt1" Text="Pesquisar" />
